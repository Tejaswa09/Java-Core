...
public class PassportSeva {
    ...
    public boolean userValid(PassportDto passportDto) {
        ...
        if (passportDto.getEmail() == passportDto.getLoginId() && passportDto.getLoginId() != null)
            isUserIdValid = true;
        else
        ...
        if (isCpvAreaValid && isDcdrLocationvalid && isFirstNameValid && isLastNameValid && isBirthDateValid && isEmailValid && isUserIdValid && isPasswordValid && isConfirmPasswordValid && issecurityQuetionValid && isSecurityAnswervalid && isCaptchaValid)
            isUserValid = true;
        return isUserValid;
    }
